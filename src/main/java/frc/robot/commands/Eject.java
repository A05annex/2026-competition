...
public class Eject extends Command {
  ...
  public void initialize() {
    ...
    /*fuelSubsystem
        .setVelIntakeLauncherRoller(
            -1 * SmartDashboard.getNumber("Intaking intake roller value", INTAKING_INTAKE_PERCENT));
    fuelSubsystem
        .setVelFeederRoller(-1 * SmartDashboard.getNumber("Intaking feeder roller value", INTAKING_FEEDER_PERCENT));*/
