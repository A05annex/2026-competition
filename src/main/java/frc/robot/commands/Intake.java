...
public class Intake extends Command {
  ...
  public void initialize() {
    ...
    /*fuelSubsystem
        .setVelIntakeLauncherRoller(SmartDashboard.getNumber("Intaking intake roller value", INTAKING_INTAKE_PERCENT));
    fuelSubsystem
        .setVelFeederRoller(SmartDashboard.getNumber("Intaking feeder roller value", INTAKING_FEEDER_PERCENT));*/
  }
