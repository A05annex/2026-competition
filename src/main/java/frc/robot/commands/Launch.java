...
public class Launch extends Command {
  ...
  public void initialize() {
    ...
    fuelSubsystem.setFeederRoller(SmartDashboard.getNumber("Launching feeder roller value", LAUNCHING_FEEDER_VOLTAGE));
       ...
       /* fuelSubsystem
        .setVelIntakeLauncherRoller(SmartDashboard.getNumber("Launching launcher roller value", LAUNCHING_LAUNCHER_PERCENT));
        fuelSubsystem
        .setVelFeederRoller(SmartDashboard.getNumber("Launching feeder roller value", LAUNCHING_FEEDER_PERCENT));*/
  }
